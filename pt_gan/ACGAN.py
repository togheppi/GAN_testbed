    ...
    def train(self, params):
        ...
        for epoch in range(params.epoch):
            ...
            for iter in range(len(self.data_X) // self.batch_size):
                ...
                logger.scalar_summary('q_loss', C_real_loss.data[0] + C_fake_loss.data[0], step + 1)
                logger.scalar_summary('q_real_loss', C_real_loss.data[0], step + 1)
                logger.scalar_summary('q_fake_loss', C_fake_loss.data[0], step + 1)
                step += 1
