...
from tf_gan.ops import *
from tf_gan.utils import *
...
class ACGAN(object):
    def __init__(self, sess, params):
        ...
        self.model_name = "ACGAN"     # name for checkpoint
            ...
            for idx in range(start_batch_id, self.num_batches):
                ...
                if np.mod(counter, 300) == 0:
                    ...
                    save_images(samples[:manifold_h*manifold_w,:,:,:], [manifold_h, manifold_w],
                          './'+params.result_dir+'/'+self.model_name+'_train_{:02d}_{:04d}.png'.format(epoch, idx))
    ...
    def visualize_results(self, epoch, result_dir):
        ...
        save_images(samples[:image_frame_dim*image_frame_dim,:,:,:], [image_frame_dim, image_frame_dim],
                    result_dir + '/' + self.model_name + '_epoch%03d' % epoch + '_test_all_classes.png')
        ...
        for l in range(self.len_discrete_code):
            ...
            samples = self.sess.run(self.fake_images, feed_dict={self.inputs:self.test_images, self.z: z_sample, self.y: y_one_hot})
            save_images(samples[:image_frame_dim*image_frame_dim,:,:,:], [image_frame_dim, image_frame_dim],
                        result_dir + '/' + self.model_name + '_epoch%03d' % epoch + '_test_class_%d.png' % l)
        ...
        save_images(canvas, [n_styles, self.len_discrete_code],
                    result_dir + '/' + self.model_name + '_epoch%03d' % epoch + '_test_all_classes_style_by_style.png')
